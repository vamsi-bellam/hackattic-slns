...
func main() {
	...
	// Two different blocks(in hex form) with same MD5 hash value -
	// Found via wiki - https://en.wikipedia.org/wiki/MD5#Collision_vulnerabilities
	// Original at  - https://www.mscs.dal.ca/~selinger/md5collision/
